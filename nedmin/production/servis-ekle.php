          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="servis_ad" value="" required="required" placeholder="Servis adı giriniz"class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <textarea  class="ckeditor" id="editor1" name="servis_detay"></textarea>
                </div>
              </div>
            ...
            <!-- Ck Editör Bitiş -->
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="servis_sira"  required="required" placeholder="Servis sırasını giriniz"  class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="servis_icon"  required="required" placeholder="Servis iconu giriniz"  class="form-control col-md-7 col-xs-12">
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button type="submit" name="serviskaydet" class="btn btn-success">Kaydet</button>
                </div>
              </div>
